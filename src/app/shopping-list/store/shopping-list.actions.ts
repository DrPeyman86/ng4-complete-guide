...
export const ADD_INGREDIENTS = 'ADD_INGREDIENTS';//this is different then above. This runs when you click on a Recipe and it runs all ingredients for that one recipe. 
